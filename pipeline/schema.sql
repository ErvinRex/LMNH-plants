...
BEGIN
    CREATE TABLE s_beta.plant (
        ...
        origin_id SMALLINT NOT NULL,
            FOREIGN KEY (origin_id) REFERENCES s_beta.origin(origin_id)
    );
END;
...
BEGIN
    CREATE TABLE s_beta.recording (
        ...
        plant_id SMALLINT NOT NULL,
            FOREIGN KEY (plant_id) REFERENCES s_beta.plant(plant_id),
        ...
        image_id BIGINT NOT NULL,
            FOREIGN KEY (image_id) REFERENCES s_beta.image(image_id),
        botanist_id SMALLINT NOT NULL,
            FOREIGN KEY (botanist_id) REFERENCES s_beta.botanist(botanist_id)
    );
END;
